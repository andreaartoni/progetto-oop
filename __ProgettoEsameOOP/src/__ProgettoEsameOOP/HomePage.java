...
public class HomePage extends JFrame implements ActionListener, MouseListener{
	...
	public void mouseClicked(MouseEvent e) {
		if(e.getSource() == diarioView){
			/*va modificato, non bisogner‡ passare una data, ma solo l'username
			 * si aprir‡ una finestra che dir‡ di selezionare una data da una JCombBox (in cui compaiono 
			 * le date associate a un determinato username), una volta selezionata la data verr‡ visualizzato il grafico
			 */
